PropelExtraPropertiesBehavior
=======================

Taken from https://github.com/Carpe-Hora/ExtraPropertiesBehavior

The *PropelExtraPropertiesBehavior* helps key/value extension for an object.

Basic example
-------------

Given a product, *PropelExtraPropertiesBehavior* add key/value extension.
...
Register behavior in your ```propel.ini``` or ```buid.properties``` configuration files :

``` ini
propel.behavior.extra_properties.class = plugins.iceBehaviorsPlugin.lib.PropelExtraPropertiesBehavior
```
...
*PropelExtraPropertiesBehavior* can do that for you.
